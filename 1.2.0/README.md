...
wizard takes first/middle/last/initials, can **generate a random password** (12–15 chars with upper,
lower, digit and special characters, no spaces), and previews the resolved attributes live before
creating the account. The template editor and New User wizard are non-modal windows.
